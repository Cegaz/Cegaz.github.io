...
__webpack_require__(/*! ./layout.js */ "./web/assets/js/layout.js");
...
/* WEBPACK VAR INJECTION */(function($) {$("#menu-apps").find("select").change(function () {
    var params = {
        newClass: $(this).val()
    };
