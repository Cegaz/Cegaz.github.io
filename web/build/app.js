...
__webpack_require__(/*! ./participation.js */ "./web/assets/js/participation.js");
__webpack_require__(/*! ./dashboard.js */ "./web/assets/js/dashboard.js");
__webpack_require__(/*! ./grades.js */ "./web/assets/js/grades.js");
__webpack_require__(/*! ./main.js */ "./web/assets/js/main.js");
...
/* WEBPACK VAR INJECTION */(function($) {$(".dashboard").find(".student-row").click(function () {
...
$("#save-comment").click(function () {
    ...
    $.post("/comment/add", params, function (data) {
        $("#comments-list").append("<p>" + data.text + "<br><span class='font-italic'>" + data.date);
        $("#comment-form").css('display', 'none');
        $("#add-comment").css('display', 'block');
    });
});
...
/* WEBPACK VAR INJECTION */(function($) {$("#add-skill").click(function () {
...
$("#save-skill").click(function () {
    ...
    $.post("/grades/add-skill", params, function (data) {
        $("#skills-list").append("<button class='btn class-btn' data-skillid=" + data.skillId + ">" + data.label + "</button>");
        $("#skill-form").addClass('hidden');
        $("#add-skill").removeClass('hidden');
    });
});
...
/* WEBPACK VAR INJECTION */(function($) {$("#list-classes").find(".class-btn").click(function () {
...
/***/ "./web/assets/js/participation.js":
/*!****************************************!*\
  !*** ./web/assets/js/participation.js ***!
  \****************************************/
/*! dynamic exports provided */
...
/* WEBPACK VAR INJECTION */(function($) {$("#students-list").find(".hand-up").click(function () {
...
$('.confirmModalButton').on('click', function () {
    ...
    var surname = td.data('surname').replace(/\b\w/g, function (l) {
