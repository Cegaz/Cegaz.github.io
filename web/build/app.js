...
/* WEBPACK VAR INJECTION */(function($) {$("#students-list").find(".student-row").click(function () {
...
$("#save-comment").click(function () {
    ...
    $.post("/comment/add", params, function (data) {
        $("#comments-list").append("<p>" + data.text + "<br><span class='font-italic'>" + data.date + "</span><img id=\"comment-modif\" src=\"/assets/images/crayon.png\"></p>");
...
/* WEBPACK VAR INJECTION */(function($) {$("#skills").find("#add-skill").click(function () {
    $("#skill-form").css('display', 'block');
    $("#add-skill").css('display', 'none');
});

$("#save-skill").click(function () {
    var params = {
        label: $("#skill-form").find("#input-text").val()
    };
    console.log(params);
